...
INSERT INTO `payroll` VALUES (1,1,160,8,69500.00),(2,2,150,10,79000.00),(3,3,170,4,54800.00),(4,4,165,6,59700.00),(5,5,158,5,57850.00),(6,6,168,2,64800.00),(7,7,175,3,71800.00),(8,8,160,0,56000.00),(9,9,155,5,61500.00),(10,10,162,4,57750.00),(11,1,160,0,70000.00),(12,4,160,0,60000.00),(13,1,160,0,70000.00);
...
CREATE TABLE `reviews` (
  ...
  KEY `employee_id` (`employee_id`),
  CONSTRAINT `reviews_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`)
...
INSERT INTO `reviews` VALUES (1,1,'2025-11','Wow, Sibongile Nkosi is amazing!','2025-11-30 10:00:00'),(2,2,'2025-11','Lungile, What a lad!','2025-11-28 14:30:00'),(3,3,'2025-11','Who is Thabo? I have never heard of him.','2025-11-25 11:15:00'),(4,2,'2025-12','NICE','2026-02-06 12:22:38');
...
-- Dump completed on 2026-02-06 15:18:56
